  ...
  apply(compiler) {
    ...
    if (HtmlWebpackPlugin && HtmlWebpackPlugin.getHooks) {
      ...
      compiler.hooks.compilation.tap('CrossoriginWebpackPlugin', (compilation) => {
        HtmlWebpackPlugin.getHooks(compilation).alterAssetTags.tapAsync(
          ...
          (htmlPluginData, callback) => {
            ...
            htmlPluginData.assetTags.scripts.forEach(
              (item) => (item.attributes.crossorigin = this.options.crossorigin),
            );
      ...
      compiler.plugin('compilation', (compilation) => {
        compilation.plugin('html-webpack-plugin-alter-asset-tags', this._addAttributeToScripts.bind(this));
      });
    }
  }
